...
import Shankaprakshalana from './components/Shankaprakshalana';
    ...
    <div className="app-root">
      <div className="mobile-frame">
        ...
        <div className="content">
          {activeTab === 'home' && <MainSections onSectionClick={setActiveTab} />}
          {activeTab === 'shankaprakshalana' && <Shankaprakshalana />}
